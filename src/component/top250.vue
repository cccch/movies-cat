<template>
    <div class="contain-fluid" id="top250">
        <div class="con">
...
<script type = "text/ecmascript-6">
    ...
    export default {
        ...
        mounted:function(){
            this.getdata('https://api.douban.com/v2/movie/top250',0,5);
        },
        computed:{
            //监听page更新电影列表
            changePage:function(){
                ...
                this.getdata('https://api.douban.com/v2/movie/top250',this.page*5-5,5);
                return this.page;
            }
        },
        //接受父组件传入的page
